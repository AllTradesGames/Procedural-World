Shader "CTS/CTS Terrain Shader Lite"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult11_g1038 = (half2(texArray5480.w , texArray5480.y));
			float2 temp_output_4_0_g1038 = ( ( ( appendResult11_g1038 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power_Close );
			...
			float2 appendResult11_g1039 = (half2(texArray4374.w , texArray4374.y));
			float2 temp_output_4_0_g1039 = ( ( ( appendResult11_g1039 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power );
			...
			float3 lerpResult5460 = lerp( appendResult20_g1038 , appendResult20_g1039 , UVmixDistance636);
			...
			float2 appendResult11_g1024 = (half2(texArray3299.w , texArray3299.y));
			float2 temp_output_4_0_g1024 = ( ( ( appendResult11_g1024 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			...
			if( _Texture_1_Normal_Index <= -1.0 )
				...
				ifLocalVar6127 = appendResult20_g1024;
			...
			float2 appendResult11_g1023 = (half2(texArray3416.w , texArray3416.y));
			float2 temp_output_4_0_g1023 = ( ( ( appendResult11_g1023 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			...
			if( _Texture_3_Normal_Index > -1.0 )
				ifLocalVar6131 = appendResult20_g1023;
			...
			float2 appendResult11_g1018 = (half2(texArray3483.w , texArray3483.y));
			float2 temp_output_4_0_g1018 = ( ( ( appendResult11_g1018 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 appendResult20_g1018 = (half3(break8_g1018.x , break8_g1018.y , temp_output_9_0_g1018));
			half3 ifLocalVar6133 = 0;
			UNITY_BRANCH 
			if( _Texture_4_Normal_Index <= -1.0 )
				ifLocalVar6133 = EmptyNRM6172;
			else
				ifLocalVar6133 = appendResult20_g1018;
			...
			float2 appendResult11_g1029 = (half2(texArray4424.w , texArray4424.y));
			float2 temp_output_4_0_g1029 = ( ( ( appendResult11_g1029 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			if( _Texture_5_Normal_Index <= -1.0 )
				...
				ifLocalVar6135 = appendResult20_g1029;
			...
			float2 appendResult11_g1028 = (half2(texArray4493.w , texArray4493.y));
			float2 temp_output_4_0_g1028 = ( ( ( appendResult11_g1028 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			if( _Texture_6_Normal_Index <= -1.0 )
				...
				ifLocalVar6138 = appendResult20_g1028;
			...
			float2 appendResult11_g1027 = (half2(texArray4567.w , texArray4567.y));
			float2 temp_output_4_0_g1027 = ( ( ( appendResult11_g1027 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			if( _Texture_7_Normal_Index <= -1.0 )
				...
				ifLocalVar6140 = appendResult20_g1027;
			...
			float2 appendResult11_g1026 = (half2(texArray4641.w , texArray4641.y));
			...
			if( _Texture_8_Normal_Index <= -1.0 )
				...
				ifLocalVar6142 = appendResult20_g1026;
			...
			float2 appendResult11_g1033 = (half2(texArray4788.w , texArray4788.y));
			float2 temp_output_4_0_g1033 = ( ( ( appendResult11_g1033 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			if( _Texture_9_Normal_Index <= -1.0 )
				...
				ifLocalVar6144 = appendResult20_g1033;
			...
			float2 appendResult11_g1032 = (half2(texArray4822.w , texArray4822.y));
			float2 temp_output_4_0_g1032 = ( ( ( appendResult11_g1032 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			if( _Texture_10_Normal_Index <= -1.0 )
				...
				ifLocalVar6146 = appendResult20_g1032;
			...
			float2 appendResult11_g1030 = (half2(texArray4856.w , texArray4856.y));
			float2 temp_output_4_0_g1030 = ( ( ( appendResult11_g1030 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			if( _Texture_11_Normal_Index <= -1.0 )
				...
				ifLocalVar6148 = appendResult20_g1030;
			...
			float2 appendResult11_g1031 = (half2(texArray4870.w , texArray4870.y));
			float2 temp_output_4_0_g1031 = ( ( ( appendResult11_g1031 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			if( _Texture_12_Normal_Index <= -1.0 )
				...
				ifLocalVar6150 = appendResult20_g1031;
			...
			float2 appendResult11_g1034 = (half2(texArray5120.w , texArray5120.y));
			float2 temp_output_4_0_g1034 = ( ( ( appendResult11_g1034 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			if( _Texture_13_Normal_Index <= -1.0 )
				...
				ifLocalVar6152 = appendResult20_g1034;
			...
			float2 appendResult11_g1036 = (half2(texArray5178.w , texArray5178.y));
			float2 temp_output_4_0_g1036 = ( ( ( appendResult11_g1036 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			if( _Texture_14_Normal_Index <= -1.0 )
				...
				ifLocalVar6154 = appendResult20_g1036;
			...
			float2 appendResult11_g1035 = (half2(texArray5246.w , texArray5246.y));
			float2 temp_output_4_0_g1035 = ( ( ( appendResult11_g1035 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			if( _Texture_15_Normal_Index <= -1.0 )
				...
				ifLocalVar6156 = appendResult20_g1035;
			...
			float2 appendResult11_g1037 = (half2(texArray5099.w , texArray5099.y));
			float2 temp_output_4_0_g1037 = ( ( ( appendResult11_g1037 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			if( _Texture_16_Normal_Index <= -1.0 )
				...
				ifLocalVar6158 = appendResult20_g1037;
