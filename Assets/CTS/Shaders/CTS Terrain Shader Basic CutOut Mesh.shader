Shader "CTS/CTS Terrain Shader Basic CutOut Mesh"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult11_g991 = (half2(texArray5480.w , texArray5480.y));
			float2 temp_output_4_0_g991 = ( ( ( appendResult11_g991 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power_Close );
			...
			float3 lerpResult5460 = lerp( appendResult20_g991 , appendResult20_g992 , UVmixDistance636);
			...
			float2 appendResult11_g776 = (half2(texArray3299.w , texArray3299.y));
			float2 temp_output_4_0_g776 = ( ( ( appendResult11_g776 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_1_Normal_Power * -1.0 ) );
			float2 break8_g776 = temp_output_4_0_g776;
			...
			float3 appendResult21_g776 = (half3(break8_g776.y , break8_g776.x , temp_output_9_0_g776));
			...
			float3 weightedAvg5676 = ( ( weightedBlendVar5676.x*( appendResult21_g776 * appendResult5874 ) + weightedBlendVar5676.y*temp_output_6001_0 + weightedBlendVar5676.z*( appendResult20_g778 * appendResult5876 ) )/( weightedBlendVar5676.x + weightedBlendVar5676.y + weightedBlendVar5676.z ) );
			...
			float2 appendResult11_g780 = (half2(texArray3384.w , texArray3384.y));
			float2 temp_output_4_0_g780 = ( ( ( appendResult11_g780 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_2_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g780 = (half3(break8_g780.y , break8_g780.x , temp_output_9_0_g780));
			...
			float2 appendResult11_g774 = (half2(texArray3351.w , texArray3351.y));
			float2 temp_output_4_0_g774 = ( ( ( appendResult11_g774 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			float2 break8_g774 = temp_output_4_0_g774;
			...
			float3 appendResult20_g774 = (half3(break8_g774.x , break8_g774.y , temp_output_9_0_g774));
			float3 appendResult5882 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar5499 = BlendComponents91;
			float3 weightedAvg5499 = ( ( weightedBlendVar5499.x*( appendResult21_g780 * appendResult5879 ) + weightedBlendVar5499.y*temp_output_6005_0 + weightedBlendVar5499.z*( appendResult20_g774 * appendResult5882 ) )/( weightedBlendVar5499.x + weightedBlendVar5499.y + weightedBlendVar5499.z ) );
			...
			float2 appendResult11_g955 = (half2(texArray3416.w , texArray3416.y));
			float2 temp_output_4_0_g955 = ( ( ( appendResult11_g955 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			...
			float3 temp_output_6008_0 = appendResult20_g955;
			...
			float2 appendResult11_g775 = (half2(texArray3445.w , texArray3445.y));
			float2 temp_output_4_0_g775 = ( ( ( appendResult11_g775 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_3_Normal_Power * -1.0 ) );
			float2 break8_g775 = temp_output_4_0_g775;
			...
			float3 appendResult21_g775 = (half3(break8_g775.y , break8_g775.x , temp_output_9_0_g775));
			...
			float3 weightedAvg5503 = ( ( weightedBlendVar5503.x*( appendResult21_g775 * appendResult5886 ) + weightedBlendVar5503.y*temp_output_6008_0 + weightedBlendVar5503.z*( appendResult20_g777 * appendResult5889 ) )/( weightedBlendVar5503.x + weightedBlendVar5503.y + weightedBlendVar5503.z ) );
			...
			float2 appendResult11_g773 = (half2(texArray3512.w , texArray3512.y));
			float2 temp_output_4_0_g773 = ( ( ( appendResult11_g773 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_4_Normal_Power * -1.0 ) );
			float2 break8_g773 = temp_output_4_0_g773;
			...
			float3 appendResult21_g773 = (half3(break8_g773.y , break8_g773.x , temp_output_9_0_g773));
			...
			float2 appendResult11_g779 = (half2(texArray3484.w , texArray3484.y));
			float2 temp_output_4_0_g779 = ( ( ( appendResult11_g779 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 appendResult20_g779 = (half3(break8_g779.x , break8_g779.y , temp_output_9_0_g779));
			float3 appendResult5896 = (half3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar5507 = BlendComponents91;
			float3 weightedAvg5507 = ( ( weightedBlendVar5507.x*( appendResult21_g773 * appendResult5893 ) + weightedBlendVar5507.y*temp_output_6011_0 + weightedBlendVar5507.z*( appendResult20_g779 * appendResult5896 ) )/( weightedBlendVar5507.x + weightedBlendVar5507.y + weightedBlendVar5507.z ) );
			...
			float2 appendResult11_g950 = (half2(texArray4417.w , texArray4417.y));
			float2 temp_output_4_0_g950 = ( ( ( appendResult11_g950 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_5_Normal_Power * -1.0 ) );
			float2 break8_g950 = temp_output_4_0_g950;
			...
			float3 appendResult21_g950 = (half3(break8_g950.y , break8_g950.x , temp_output_9_0_g950));
			...
			float2 appendResult11_g947 = (half2(texArray4422.w , texArray4422.y));
			float2 temp_output_4_0_g947 = ( ( ( appendResult11_g947 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 weightedAvg5511 = ( ( weightedBlendVar5511.x*( appendResult21_g950 * appendResult5900 ) + weightedBlendVar5511.y*temp_output_6014_0 + weightedBlendVar5511.z*( appendResult20_g947 * appendResult5903 ) )/( weightedBlendVar5511.x + weightedBlendVar5511.y + weightedBlendVar5511.z ) );
			...
			float2 appendResult11_g965 = (half2(texArray4493.w , texArray4493.y));
			float2 temp_output_4_0_g965 = ( ( ( appendResult11_g965 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 temp_output_6017_0 = appendResult20_g965;
			...
			float2 appendResult11_g951 = (half2(texArray4486.w , texArray4486.y));
			float2 temp_output_4_0_g951 = ( ( ( appendResult11_g951 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_6_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g951 = (half3(break8_g951.y , break8_g951.x , temp_output_9_0_g951));
			...
			float2 appendResult11_g948 = (half2(texArray4491.w , texArray4491.y));
			...
			float3 weightedAvg5519 = ( ( weightedBlendVar5519.x*( appendResult21_g951 * appendResult5907 ) + weightedBlendVar5519.y*temp_output_6017_0 + weightedBlendVar5519.z*( appendResult20_g948 * appendResult5910 ) )/( weightedBlendVar5519.x + weightedBlendVar5519.y + weightedBlendVar5519.z ) );
			...
			float2 appendResult11_g969 = (half2(texArray4567.w , texArray4567.y));
			...
			float3 temp_output_6020_0 = appendResult20_g969;
			...
			float2 appendResult11_g952 = (half2(texArray4560.w , texArray4560.y));
			float2 temp_output_4_0_g952 = ( ( ( appendResult11_g952 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_7_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g952 = (half3(break8_g952.y , break8_g952.x , temp_output_9_0_g952));
			...
			float2 appendResult11_g958 = (half2(texArray4565.w , texArray4565.y));
			float2 temp_output_4_0_g958 = ( ( ( appendResult11_g958 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 weightedAvg5523 = ( ( weightedBlendVar5523.x*( appendResult21_g952 * appendResult5914 ) + weightedBlendVar5523.y*temp_output_6020_0 + weightedBlendVar5523.z*( appendResult20_g958 * appendResult5917 ) )/( weightedBlendVar5523.x + weightedBlendVar5523.y + weightedBlendVar5523.z ) );
			...
			float2 appendResult11_g960 = (half2(texArray4641.w , texArray4641.y));
			float2 temp_output_4_0_g960 = ( ( ( appendResult11_g960 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 temp_output_6023_0 = appendResult20_g960;
			...
			float2 appendResult11_g949 = (half2(texArray4639.w , texArray4639.y));
			float2 temp_output_4_0_g949 = ( ( ( appendResult11_g949 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 weightedAvg5527 = ( ( weightedBlendVar5527.x*( appendResult21_g954 * appendResult5921 ) + weightedBlendVar5527.y*temp_output_6023_0 + weightedBlendVar5527.z*( appendResult20_g949 * appendResult5924 ) )/( weightedBlendVar5527.x + weightedBlendVar5527.y + weightedBlendVar5527.z ) );
			...
			float2 appendResult11_g975 = (half2(texArray4788.w , texArray4788.y));
			float2 temp_output_4_0_g975 = ( ( ( appendResult11_g975 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 temp_output_6047_0 = appendResult20_g975;
			...
			float2 appendResult11_g961 = (half2(texArray5285.w , texArray5285.y));
			float2 temp_output_4_0_g961 = ( ( ( appendResult11_g961 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_9_Normal_Power * -1.0 ) );
			...
			float2 appendResult11_g967 = (half2(texArray4783.w , texArray4783.y));
			float2 temp_output_4_0_g967 = ( ( ( appendResult11_g967 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 weightedAvg5491 = ( ( weightedBlendVar5491.x*( appendResult21_g961 * appendResult5977 ) + weightedBlendVar5491.y*temp_output_6047_0 + weightedBlendVar5491.z*( appendResult20_g967 * appendResult5980 ) )/( weightedBlendVar5491.x + weightedBlendVar5491.y + weightedBlendVar5491.z ) );
			...
			float3 temp_output_6044_0 = appendResult20_g980;
			...
			float2 appendResult11_g972 = (half2(texArray4798.w , texArray4798.y));
			float2 temp_output_4_0_g972 = ( ( ( appendResult11_g972 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_10_Normal_Power * -1.0 ) );
			...
			float2 appendResult11_g968 = (half2(texArray4791.w , texArray4791.y));
			float2 temp_output_4_0_g968 = ( ( ( appendResult11_g968 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 weightedAvg5531 = ( ( weightedBlendVar5531.x*( appendResult21_g972 * appendResult5970 ) + weightedBlendVar5531.y*temp_output_6044_0 + weightedBlendVar5531.z*( appendResult20_g968 * appendResult5973 ) )/( weightedBlendVar5531.x + weightedBlendVar5531.y + weightedBlendVar5531.z ) );
			...
			float2 appendResult11_g973 = (half2(texArray4828.w , texArray4828.y));
			float2 temp_output_4_0_g973 = ( ( ( appendResult11_g973 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_11_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g973 = (half3(break8_g973.y , break8_g973.x , temp_output_9_0_g973));
			...
			float3 weightedAvg5535 = ( ( weightedBlendVar5535.x*( appendResult21_g973 * appendResult5963 ) + weightedBlendVar5535.y*temp_output_6041_0 + weightedBlendVar5535.z*( appendResult20_g971 * appendResult5966 ) )/( weightedBlendVar5535.x + weightedBlendVar5535.y + weightedBlendVar5535.z ) );
			...
			float2 appendResult11_g976 = (half2(texArray4870.w , texArray4870.y));
			float2 temp_output_4_0_g976 = ( ( ( appendResult11_g976 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 temp_output_6038_0 = appendResult20_g976;
			...
			float2 appendResult11_g964 = (half2(texArray4850.w , texArray4850.y));
			float2 temp_output_4_0_g964 = ( ( ( appendResult11_g964 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_12_Normal_Power * -1.0 ) );
			...
			float2 appendResult11_g966 = (half2(texArray4852.w , texArray4852.y));
			...
			float3 weightedAvg5539 = ( ( weightedBlendVar5539.x*( appendResult21_g964 * appendResult5956 ) + weightedBlendVar5539.y*temp_output_6038_0 + weightedBlendVar5539.z*( appendResult20_g966 * appendResult5959 ) )/( weightedBlendVar5539.x + weightedBlendVar5539.y + weightedBlendVar5539.z ) );
			...
			float2 appendResult11_g987 = (half2(texArray5120.w , texArray5120.y));
			float2 temp_output_4_0_g987 = ( ( ( appendResult11_g987 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 temp_output_6035_0 = appendResult20_g987;
			...
			float2 appendResult11_g978 = (half2(texArray5127.w , texArray5127.y));
			float2 temp_output_4_0_g978 = ( ( ( appendResult11_g978 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_13_Normal_Power * -1.0 ) );
			...
			float2 appendResult11_g983 = (half2(texArray5109.w , texArray5109.y));
			float2 temp_output_4_0_g983 = ( ( ( appendResult11_g983 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 weightedAvg5543 = ( ( weightedBlendVar5543.x*( appendResult21_g978 * appendResult5949 ) + weightedBlendVar5543.y*temp_output_6035_0 + weightedBlendVar5543.z*( appendResult20_g983 * appendResult5952 ) )/( weightedBlendVar5543.x + weightedBlendVar5543.y + weightedBlendVar5543.z ) );
			...
			float2 appendResult11_g986 = (half2(texArray5178.w , texArray5178.y));
			float2 temp_output_4_0_g986 = ( ( ( appendResult11_g986 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 temp_output_6032_0 = appendResult20_g986;
			...
			float2 appendResult11_g977 = (half2(texArray5017.w , texArray5017.y));
			float2 temp_output_4_0_g977 = ( ( ( appendResult11_g977 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_14_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g977 = (half3(break8_g977.y , break8_g977.x , temp_output_9_0_g977));
			...
			float2 appendResult11_g982 = (half2(texArray5170.w , texArray5170.y));
			float2 temp_output_4_0_g982 = ( ( ( appendResult11_g982 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 weightedAvg5547 = ( ( weightedBlendVar5547.x*( appendResult21_g977 * appendResult5942 ) + weightedBlendVar5547.y*temp_output_6032_0 + weightedBlendVar5547.z*( appendResult20_g982 * appendResult5945 ) )/( weightedBlendVar5547.x + weightedBlendVar5547.y + weightedBlendVar5547.z ) );
			...
			float2 appendResult11_g988 = (half2(texArray5246.w , texArray5246.y));
			float2 temp_output_4_0_g988 = ( ( ( appendResult11_g988 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 temp_output_6029_0 = appendResult20_g988;
			...
			float2 appendResult11_g979 = (half2(texArray5227.w , texArray5227.y));
			float2 temp_output_4_0_g979 = ( ( ( appendResult11_g979 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_15_Normal_Power * -1.0 ) );
			...
			float3 appendResult21_g979 = (half3(break8_g979.y , break8_g979.x , temp_output_9_0_g979));
			...
			float2 appendResult11_g974 = (half2(texArray5250.w , texArray5250.y));
			float2 temp_output_4_0_g974 = ( ( ( appendResult11_g974 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 weightedAvg5551 = ( ( weightedBlendVar5551.x*( appendResult21_g979 * appendResult5935 ) + weightedBlendVar5551.y*temp_output_6029_0 + weightedBlendVar5551.z*( appendResult20_g974 * appendResult5938 ) )/( weightedBlendVar5551.x + weightedBlendVar5551.y + weightedBlendVar5551.z ) );
			...
			float2 appendResult11_g989 = (half2(texArray5099.w , texArray5099.y));
			float2 temp_output_4_0_g989 = ( ( ( appendResult11_g989 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 temp_output_6026_0 = appendResult20_g989;
			...
			float3 weightedAvg5555 = ( ( weightedBlendVar5555.x*( appendResult21_g981 * appendResult5928 ) + weightedBlendVar5555.y*temp_output_6026_0 + weightedBlendVar5555.z*( appendResult20_g985 * appendResult5931 ) )/( weightedBlendVar5555.x + weightedBlendVar5555.y + weightedBlendVar5555.z ) );
			...
			float2 appendResult11_g990 = (half2(texArray4382.w , texArray4382.y));
			float2 temp_output_4_0_g990 = ( ( ( appendResult11_g990 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Snow_Normal_Scale );
			...
			if( _Texture_Snow_Normal_Index <= -1.0 )
				...
				ifLocalVar6166 = appendResult20_g990;
			float simplePerlin2D6330 = snoise( ( Top_Bottom1999 * _Snow_Noise_Tiling ) );
			float lerpResult4310 = lerp( 1.0 , simplePerlin2D6330 , _Snow_Noise_Power);
