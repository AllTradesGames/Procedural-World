Shader "CTS/CTS Terrain Shader Basic LOD"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half localMyCustomExpression6172 = ( 0.0 );
			v.tangent.xyz = cross ( v.normal, float3( 0, 0, 1 ) );
			v.tangent.w = -1;
			half3 temp_cast_0 = (localMyCustomExpression6172).xxx;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			half3 temp_cast_1 = (WorldNormalVector( i , _Vector0 ).y).xxx;
			float clampResult4302 = clamp( ( 1.0 * _Snow_Amount ) , 0.4 , 1.0 );
			...
			float lerpResult3951 = lerp( ( break3856.w * _Terrain_Smoothness ) , break1409.w , lerpResult3742.x);
