...
namespace CTS
{
    ...
    public class CTSWeatherManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            Color winterTint = EditorGUILayout.ColorField(GetLabel("Winter Tint"), m_manager.WinterTint);
            DrawHelpLabel("Winter Tint");

            Color springTint = EditorGUILayout.ColorField(GetLabel("Spring Tint"), m_manager.SpringTint);
            DrawHelpLabel("Spring Tint");

            Color summerTint = EditorGUILayout.ColorField(GetLabel("Summer Tint"), m_manager.SummerTint);
            DrawHelpLabel("Summer Tint");

            Color autumnTint = EditorGUILayout.ColorField(GetLabel("Autumn Tint"), m_manager.AutumnTint);
